...
```powershell
powershell -ExecutionPolicy Bypass -File tools\package-client.ps1 -Version 0.1.9-alpha
powershell -ExecutionPolicy Bypass -File tools\publish-release.ps1 -Version 0.1.9-alpha
```
